      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-700 dark:text-blue-300">{totalJobs}</p>
              </div>
        ...
        <Card className="border-0 bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-green-600 dark:text-green-400">Companies</p>
                <p className="text-2xl font-bold text-green-700 dark:text-green-300">{uniqueCompanies}</p>
              </div>
        ...
        <Card className="border-0 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-purple-600 dark:text-purple-400">Remote Jobs</p>
                <p className="text-2xl font-bold text-purple-700 dark:text-purple-300">{remoteJobs}</p>
              </div>
        ...
        <Card className="border-0 bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/70 backdrop-blur-sm">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-orange-600 dark:text-orange-400">Locations</p>
                <p className="text-2xl font-bold text-orange-700 dark:text-orange-300">{uniqueLocations}</p>
              </div>
      ...
      {topTags.length > 0 && (
        <Card className="border-0 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm">
          <CardHeader>
            ...
            <CardDescription>Distribution of job types in your search results</CardDescription>
          </CardHeader>
